...
class WitnessPage extends StatefulWidget {
  const WitnessPage({Key? key}) : super(key: key);
...
class _WitnessPageState extends State<WitnessPage> {
  ...
  Future<void> _fetchSongsAndCache() async {
    ...
    List<Song> songs = await Provider.of<SongProvider>(context, listen: false).getSongsByCollection('Testimony');
    setState(() {
      _songList = songs;
    });
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: SingleChildScrollView(
              ...
              const Center(
                child: Text('हाम्रा प्रभुको साक्षीको विषयमा नलजाऊ।',
                    style: TextStyle(
                      fontSize: 18,
                    )),
              ),
              const Center(
                child: Text('२ तिमोथी १:८',
                    style: TextStyle(
                        fontSize: 16,
              ...
              provider.isLoading
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SongWidget(
                          song: song,
                          playingSongList: _songList, collectionName: 'Testimony',
                        );
                      },
                    ),
