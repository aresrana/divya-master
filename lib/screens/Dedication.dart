...
class DedicationPage extends StatefulWidget {
  const DedicationPage({Key? key}) : super(key: key);
...
class _DedicationPageState extends State<DedicationPage> {
  ...
  Future<void> _fetchSongsAndCache() async {
    ...
    List<Song> songs = await Provider.of<SongProvider>(context, listen: false).getSongsByCollection('Dedication');
    setState(() {
      _songList = songs;
    });
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: SingleChildScrollView(
              ...
              const Center(
                child: Text('यसकारण आफूलाई परमेश्वरको अधीनतामा सुम्प।',
                    style: TextStyle(
                      fontSize: 18,
                    )),
              ),
              const Center(
                child: Text('याकूब ४:७',
                    style: TextStyle(
                        fontSize: 16,
              ...
              provider.isLoading
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SongWidget(
                          song: song,
                          playingSongList: _songList, collectionName: 'Dedication',
                        );
                      },
                    ),
