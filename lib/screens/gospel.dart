...
class GospelPage extends StatefulWidget {
  const GospelPage({Key? key}) : super(key: key);

  @override
  State<GospelPage> createState() => _GospelPageState();
}
...
class _GospelPageState extends State<GospelPage> {
  ...
  Future<void> _fetchSongsAndCache() async {
    ...
    List<Song> songs = await Provider.of<SongProvider>(context, listen: false).getSongsByCollection('Gospel');
    setState(() {
      _songList = songs;
    });
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: SingleChildScrollView(
              ...
              const Center(
                child: Text('सारा संसारमा जाओ, र...सुसमाचार प्रचार गर!',
                    style: TextStyle(
                      fontSize: 18,
                    )),
              ),
              ...
              provider.isLoading
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SongWidget(
                          song: song,
                          playingSongList: _songList, collectionName: 'Gospel',
                        );
                      },
                    ),
