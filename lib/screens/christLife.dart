...
class ChristLifePage extends StatefulWidget {
  const ChristLifePage({Key? key}) : super(key: key);

  @override
  State<ChristLifePage> createState() => _ChristLifePageState();
}

class _ChristLifePageState extends State<ChristLifePage> {
  ...
  Future<void> _fetchSongsAndCache() async {
    ...
    List<Song> songs = await Provider.of<SongProvider>(context, listen: false).getSongsByCollection('Christ_Life');
    setState(() {
      _songList = songs;
    });
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: Text(
                  'चाखेर हेर;परमप्रभु कति भला हुनुहुन्छ।',
                  style: TextStyle(
                    fontSize: 18,
                  ),
                ),
              ...
              provider.isLoading
                ...
                itemBuilder: (context, index) {
                  ...
                  return SongWidget(
                    song: song,
                    playingSongList: _songList, collectionName: 'Christ_Life',
                  );
                },
              ),
