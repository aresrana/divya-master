...
class DeathPage extends StatefulWidget {
  const DeathPage({Key? key}) : super(key: key);
...
class _DeathPageState extends State<DeathPage> {
  ...
  Future<void> _fetchSongsAndCache() async {
    ...
    List<Song> songs = await Provider.of<SongProvider>(context, listen: false).getSongsByCollection('Death');
    setState(() {
      _songList = songs;
    });
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: SingleChildScrollView(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                      image: AssetImage('images/tomb.jpg'), fit: BoxFit.cover),
                ),
              ),
              const SizedBox(
                height: 28,
              ...
              const Center(
                child: Text('किनभने मानिसको आयू तोकिएको छ।',
                    style: TextStyle(
                      fontSize: 18,
                    )),
              ),
              const Center(
                child: Text('अय्यूब १४:५',
                    style: TextStyle(
                        fontSize: 16,
              ...
              provider.isLoading
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SongWidget(
                          song: song,
                          playingSongList: _songList, collectionName: 'Death',
                        );
                      },
                    ),
