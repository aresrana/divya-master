...
class AtiriktaPage extends StatefulWidget {
  const AtiriktaPage({Key? key}) : super(key: key);

  @override
  State<AtiriktaPage> createState() => _AtiriktaPageState();
}

class _AtiriktaPageState extends State<AtiriktaPage> {
  ...
  Future<void> _fetchSongsAndCache() async {
    ...
    List<Song> songs = await Provider.of<SongProvider>(context, listen: false).getSongsByCollection('Atirikta');
    setState(() {
      _songList = songs;
    });
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: SingleChildScrollView(
              ...
              const Center(
                child: Text('तपाईंका वचनहरू महभन्दा पनि गुलिया छन्। ',
                    style: TextStyle(
                      fontSize: 18,
                    )),
              ),
              const Center(
                child: Text('भजन ११९:१०३',
                    style: TextStyle(
                        fontSize: 16,
              ...
              provider.isLoading
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return SongWidget(
                          song: song,
                          playingSongList: _songList, collectionName: 'Atirikta',
                        );
                      },
                    ),
