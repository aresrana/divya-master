...
class _WorshipSongPage extends State<WorshipSongPage> {
  ...
  void initState() {
    Provider.of<SongProvider>(context, listen: false)
      ...
      for(var i =0;i<_songList.length;i++){
        final mu = await cacheManager.getSingleFile(Uri.encodeFull(_songList[i].music));
       ...
       final na = await cacheManager.getSingleFile(_songList[i].name);
        ...
        final _cacheList = Song(music: mu.path, title: ti.path, url: ur.path,name: na.path);
  ...
  Widget build(BuildContext context) {
    ...
    return   Scaffold(
          appBar: AppBar(
            title: Text("आराधनाका गीतहरू",style: TextStyle(color: Colors.black),),
    ...
    //                 child: MiniPlayer()) : null,
                ...
                child: Column(
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: Colors.grey.shade300, width: 10),
      ...
      floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked, // change the location here
