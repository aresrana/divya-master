...
class WorshipSongPage extends StatefulWidget {
  ...
  @override
  State<WorshipSongPage> createState() => _WorshipSongPageState();
}

class _WorshipSongPageState extends State<WorshipSongPage> {
  List<Song> _songList = [];
  ...
  Future<void> _fetchSongsAndCache() async {
    ...
    List<Song> songs = await Provider.of<SongProvider>(context, listen: false).getSongsByCollection('Worship');
            ...
            children: [
              ...
              provider.isLoading
                ...
                itemBuilder: (context, index) {
                  ...
                  return SongWidget(
                    song: song,
                    playingSongList: _songList, collectionName: 'Worship',
                  );
                },
              ),
